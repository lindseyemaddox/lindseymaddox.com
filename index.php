...
<section id="portfolio">
  ...
  <div id="options" class="clearfix">
 	...
 	<div id="container" class="clearfix">
	    ...
	    <a href="http://meetidesign.com/" target="_blank" rel="nofollow"class="element-item build fluid production">
	    	<img src="/_img/meet-idesign.jpg" alt="iDesign, Inc. website">
	    </a><!--element-->

	    <a href="http://www.connico.com/" target="_blank" rel="nofollow"class="element-item build production">
...
--><!--element-->
	    ...
	    <a href="http://roofingbymidsouth.com/" target="_blank" rel="nofollow"class="element-item build fluid production">
	    	<img src="/_img/midsouth-construction.jpg" alt="MidSouth Construction website">
	    </a><!--element-->

	    <a href="http://www.sharedhospital.com/" target="_blank" rel="nofollow"class="element-item build fluid production">
	    ...
	    <a href="http://theeastnashvillian.com/" target="_blank" rel="nofollow"class="element-item build fluid production">
	    	<img src="/_img/the-east-nashvillian.jpg" alt="The East Nashvillian website">
	    </a><!--element-->	    

	    <a href="http://thesmartpops.com/" target="_blank" rel="nofollow"class="element-item build fluid production">
	    ...
	    <a href="http://appletonlearning.com/" target="_blank" rel="nofollow"class="element-item fluid build production">
	    	<img src="/_img/appleton.jpg" alt="Appleton Learning website">
	    </a><!--element-->

	    <a href="http://betterhearingbyphonak.com/" target="_blank" rel="nofollow"class="element-item fluid build production">
	    	<img src="/_img/better-hearing-by-phonak.jpg" alt="Better Hearing by Phonak website">
	    </a><!--element-->

	    <a href="http://www.beyondtheboxproductions.com/" target="_blank" rel="nofollow"class="element-item fluid build production">
	    	<img src="/_img/beyond-the-box.jpg" alt="Beyond the Box Productions website">
	    </a><!--element-->

	    <a href="http://www.beckfortn.com/" target="_blank" rel="nofollow"class="element-item build production">
...
--><!--element-->
	    ...
	    <a href="http://landonlackeylaw.com/" target="_blank" rel="nofollow"class="element-item build fluid production">
	    	<img src="/_img/landon-lackey.jpg" alt="Landon Lackey website">
	    </a><!--element-->

	    <a href="http://www.roseconstruction.com/" target="_blank" rel="nofollow"class="element-item build production">
	    	<img src="/_img/rose-construction.jpg" alt="Rose Construction website">
	    </a><!--element-->	    

	    <a href="http://www.veteransdisabilitybenefits.net/" target="_blank" rel="nofollow"class="element-item build breakpoint production">
